...
if ($krsnya2 != 0){
echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=home_mhs.php?file=input krs NonPaket&aka=$aka&ter=$ter&san=$san&token=$token&q=$q&m=$m&lum=$lum'></head><body><center><br><font color='#FF0000'><b>Maaf, Mata Kuliah $data_mk[matkul] Sudah Di Ambil</b></font><br></center></body></html>";
exit;
}
...
<table width="100%" border="0" align="center">  
    <td><center><font size="+2"><strong>FORM INPUT KARTU RENCANA STUDI (KRS NonPaket)</strong></font></center></td>
  </tr>
</table>
<table width="100%" border="0" align="center">
...
$cekquery2= mysql_query("SELECT * from matkul where id_kurikulum='$hasilnya[id_kurikulum]' and id_prodi='$hasilnya[id_prodi]' order by  id_smt asc ");
    ...
    <tr onMouseOver=bgColor="#CCCCCC" onMouseOut=bgColor="#FFFFFF"> 
      ...
      <td class="kiribawahkanan" align="center"><? echo "<input name='id_mk[]' type=checkBox value=$data2[id_mk] >"; ?></td>
      <? 
					}
			?>
    </tr>
