...
$id_smt=$_POST[id_smt];
 ...
 echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=user.php?file=hasil lihat uts&aka=$aka&ter=$ter&san=$san&token=$token&q=$q&m=$m&lum=$lum&nim=$nim&id_smt=$id_smt&id_kurikulum=$id_kurikulum&id_prodi=$id_prodi' ></head><body><center>Data diproses...</center</body></html>";
 }
