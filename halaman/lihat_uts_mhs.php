...
$ambil_data= "SELECT *from krs_khs where id_prodi='$id_prodi' and id_mhs='$data_up[id_mhs]' and id_smt='$data_up0[id_smt]' and id_kelas='$data_up77[id_kurikulum]'";
...
<?
		$cekquery= "SELECT *from uts where id_prodi='$id_prodi' and nim='$data_up[nim]' and id_mhs='$data_up[id_mhs]' and id_smt='$data_up0[id_smt]' and id_kelas='$id_kurikulum' order by id_mk asc";
