<?
require ("server.php");
 $password=base64_decode($q);


$ambil= "SELECT * from paswrd_khs where  paswrd='$password'";
...
$id_smt=$_POST[id_smt];
 ...
 echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=user.php?file=hasil lihat krs&aka=$aka&ter=$ter&san=$san&token=$token&q=$q&m=$m&lum=$lum&nim=$nim&id_smt=$id_smt&id_kurikulum=$id_kurikulum&id_prodi=$id_prodi' ></head><body><center>Data diproses...</center</body></html>";
 }
...
<table width="35%" border="0" align="center" bgcolor="#CC9933">
	<tr>		
      <td align="center" colspan="3"><strong><font color="#FFFFFF">PILIH SEMESTER DAN KELAS KHS</font></strong></td>
	</tr>
</tr>
  <tr>
