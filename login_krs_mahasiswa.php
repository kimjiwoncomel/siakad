...
<div id="content_bg">
   <? 
	...
	<div class="pad">
	<form name="proses" method="post" action="cek.php">
<center>
<table width="44%" border="0" align="center" bgcolor="#3D59AB">
	<tr>		
      <td align="center" colspan="3"><strong><font color="#FFFFFF">LOGIN KHS MAHASISWA 
      </font></strong></td>
	</tr>
		<tr>
...
?>
  ...
  <tr>
    ...
    <td align="center">:</td>
    <td align="left"><input type="text" name="paswrd" size="27" maxlength="40"></td>
  </tr>
</table>
</center>
<center><tr align="center"><td><input type="submit" value="Simpan" name="mhskhs">
&nbsp; &nbsp;<input type="reset" value="Reset"></tr></td> 
<br>
<a href="index.php">Kembali</a> | <a href="tambah_user_mahasiswa_khs.php"><h3>Daftar Akun KHS </a>
</center>
</form>
	</div>
				</div>
