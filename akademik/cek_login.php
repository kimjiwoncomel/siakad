...
if ($token2==$cek_token2){
			...
			$cekAngg_up="SELECT *from userm where username='$username' and password='$password' and id_mk='$id_mk'";
		...
		echo"<br><b><font color=red><center>Login ERROR ...!!!!</center></font></b>";		
			echo"<html><head><title></title><meta http-equiv=''content='1;URL=akademik/kema.php'></head><body></body></html>";
		exit;
		}
if($data_up2!="0")
{
...
$kategori=base64_encode($id_mk);
			...
			echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=file.php?sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi'></head><body></body></html>";
			exit;
		}
	...
	{
		echo"<br><b><font color=red><center>Login ERROR ...!!!!</center></font></b>";		
			echo"<html><head><title></title><meta http-equiv=''content='1;URL=index.php?page=akademik login'></head><body></body></html>";
		exit;
	}
	}
