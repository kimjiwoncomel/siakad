...
{
echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=home_admin.php?file=atur matkul tambah&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi2&id_kurikulum=$id_kurikulum'></head><body><center><strong><font color='#FF0000'>Data tidak lengkap</font></strong></center></body></html>";
exit;
}
else
{
...
if ($data_mk>=1){
echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=home_admin.php?file=atur matkul tambah&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi2&id_kurikulum=$id_kurikulum'></head><body><center><strong><font color='#FF0000'>Maaf kode MK $kode_mk sudah ada</font></strong></center></body></html>";
exit;
}
...
echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=home_admin.php?file=atur matkul&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi2&id_kurikulum=$id_kurikulum'></head><body><center><strong><font color='#0000FF'>Input berhasil</font></strong></center></body></html>";
exit;
}
}
?>
...
?>
<h3 align="center">INPUT MATA KULIAH PRODI <? echo $data_prodi[jenjang];?> <? echo $data_prodi[nama_prodi];?> KURIKULUM <? echo $data_kurikulum[nama_kurikulum];?></h3>
