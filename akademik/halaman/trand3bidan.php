...
<table width="100%" border="0" align="center" class="hurufarial">
  <tr>
    ...
    <td width="2%">&nbsp;</td>
 <td width="20%"><font size="-1">Program Studi : D-III Kebidanan<br>
    <em>Study Program   :   Diploma III Midwifery </em></font></td>
...
?>
   ...
   <tr>
				  ...
				  <td class="kiribawah" align="left"><font size="-1">&nbsp;&nbsp;JUMLAH SKS </font></td>  
				  ...
				  <td class="kiribawahkanan" align="center"><? echo(number_format($jum_bobot_tot,2,chr(44),"."));?></td>   
   </tr> 
	<tr>
				  <td class="kiribawah" align="center"><font size="-1">&nbsp;</font></td>
				  <td class="kiribawah" align="left"><font size="-1">&nbsp;&nbsp;JUMLAH NILAI </font></td>  
...
<table width="100%" border="0" align="center" class="hurufarial">
  ...
  <tr>
    ...
    <td width="34%" align="center"><font size="-1">NIK : <? echo"$data_kajur2[nip]"; ?></font></td>
       ...
       <p align="center"><strong>NILAI UJIAN AKHIR PROGRAM <br>
       <em>Final Exam Grade Point of Study Program </em>
       </strong><br>
</p>
       <p>1. Nilai Ujian Praktek Kebidanan :<br>
	   &nbsp;&nbsp;&nbsp;&nbsp;<em>Grade Point of Midwifery Practice </em></p>
        <?
		$ambil_p= "SELECT *from praktek where nim='$data_jurusan[nim]'";
		$ambil_pp=mysql_query($ambil_p);
		echo mysql_error();
		$ambil_pnya = mysql_fetch_array($ambil_pp);
		 $ambil_pnya[nilai];
		 $titik = number_format($ambil_pnya[nilai],2,chr(44),".");
		//=================
?>
  <table width="100%" border="0" class="garisbawah, hurufarial" align="center" cellpadding='1'>
      
  <tr>
      <td class="kotak"><div align="center"><? echo $ambil_pnya[nilai];?><br>( <? echo terbilang($titik);?> )<br><? echo $ambil_pnya[nilai];?><br>
      ( <? echo terbilang2($titik);?> )</div></td>
  </tr>
</table>

<p>2.  Judul Penulisan Karya Tulis ILmiah (KTI):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
?>
  ...
  <tr>
      <td class="kotak"><div align="center"><? echo $ambil_judulnya[judul];?><br></div></td>
       ...
       <p align="center"><strong>Y U D S I U M  <br>
       <em>Proficiency</em>
       </strong><br>
</p>
<p>1. Nilai A = Indeks Prestasi Kumulatif Semester 1 s/d 6 (Bobot 60%) :<br>
...
?>
  <table width="100%" border="0" class="garisbawah, hurufarial" align="center" cellpadding='1'>
      <?
	  $kuala = number_format($ip_komulatif,2,chr(44),".");
	  $kualanya=60*$kuala;
	  $kurla=$kualanya/100;
	  ...
	  ?>
  <tr>
      <td class="kotak"><div align="center">60 % dari <? echo(number_format($ip_komulatif,2,chr(44),"."));?> = <? echo $kur;?><br>
          (<? echo terbilang($kur);?>)<br>
          60 % from <? echo(number_format($ip_komulatif,2,chr(44),"."));?> = <? echo $kur;?><br>
          (<? echo terbilang2($kur);?>)</div></td>
  </tr>
</table>

<p>2. Nilai B = Indeks Ujian Praktek Kebidanan (Bobot 40%) :<br>
  &nbsp;&nbsp;&nbsp;&nbsp;<span class="style4">Grade B = Semester Grade Point Avarange on Study </span></p>
        <?
		$ambil_p= "SELECT *from praktek where nim='$data_jurusan[nim]'";
		$ambil_pp=mysql_query($ambil_p);
		echo mysql_error();
		$ambil_pnya = mysql_fetch_array($ambil_pp);
		 $ambil_pnya[nilai];
		  ...
		  $kuala2 = number_format($ambil_pnya[nilai],2,chr(44),".");
	  $kualanya2=40*$kuala2;
...
?>
  ...
  <tr>
      <td class="kotak"><div align="center">40 % dari <? echo $ambil_pnya[nilai];?> = <? echo $kur2;?> <br>
          (<? echo terbilang($kur2);?>)<br>
          40 % from <? echo $ambil_pnya[nilai];?> = <? echo $kur2;?> <br>
          (<? echo terbilang2($kur2);?>)</div></td>
  </tr>
</table>
<p>3.  Indeks Prestasi Kumulatif (IPK) Akhir Progam : Nilai A + Nilai B <br>
...
?>
  ...
  <?
  $jum= $kur+$kur2;
    $jum2 = number_format($jum,2,chr(44),".");
  ?>
      
  <tr>
      <td class="kotak"><div align="center">Nilai A + Nilai B <br>
      <? echo $kur;?> +  <? echo $kur2;?> = <? echo(number_format($jum,2,chr(44),"."));?><br>
          (<? echo terbilang($jum2);?>)<br>Grade A + Grade B<br>
           <? echo $kur;?> +  <? echo $kur2;?> = <? echo(number_format($jum,2,chr(44),"."));?><br>
          (<? echo terbilang2($jum2);?>)</div></td>
  </tr>
</table>
