...
<?
$ambil_mhs= mysql_query("SELECT *from uts where id_prodi='$id_prodi' and th_akademik='$th_akademik' and id_smt='$data_smt[id_smt]'  group by id_mhs order by id_krs_perawat asc");
$noUrut = 0;
...
$noUrut++;
	...
	<? echo"<a href='home_admin.php?file=cek hasil cetak nilai uts&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&nim=$mhs2[nim]&semester=$data_smt[semester]&id_kelas=$id_kelas&th_akademik=$th_akademik&id_prodi=$id_prodi&id_smt=$id_smt'><strong><font color='#0000FF'> [Lihat UTS]</font></strong></a>";?> 
        &nbsp;&nbsp&nbsp; <? echo"<a href='./halaman/cetak_uts.php?nim=$mhs2[nim]&semester=$data_smt[semester]&id_kelas=$id_kelas&id_kurikulum=$id_kurikulum&th_akademik=$th_akademik' target='_blank'><strong><font color='#0000FF'>[Cetak UTS]</font></strong></a>";?> 
        &nbsp;&nbsp&nbsp; <? echo"<a href=./halaman/uts_excel_download.php?nim=$mhs2[nim]&semester=$data_smt[semester]&id_kelas=$id_kelas&th_akademik=$th_akademik><strong><font color='#0000FF'>[Download Permahasiswa]</font></strong></a>";?> 
      </td>    
    <? 
	}
	?>	 
