...
?>
  <table width="50%" border="0" align="center" class="unnamed1">
    <tr> 
      <td colspan="3"><strong>HAPUS PROGRAM KELAS <br>
        </strong></td>
    </tr>
    <tr> 
      <td nowrap>Nama Program Kelas</td>
      <td>&nbsp;</td>
      <td><input name="kelas" type="text" class="unnamed1" id="kelas" value="<? echo $data[kelas];?>" size="50" maxlength="50" disabled></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input type="submit" name="proses" value="Hapus"><input name="sinyal" type="hidden" value="<? echo $sinyal;?>"><input name="token" type="hidden" value="<? echo $token;?>"><input name="identifikasi" type="hidden" value="<? echo $identifikasi;?>"><input name="id_prodi" type="hidden" value="<? echo $id_prodi;?>"><input name="kategori" type="hidden" value="<? echo $kategori;?>">&nbsp;&nbsp;[<? echo "<a href=\"home_admin.php?file=atur kelas&id_prodi=$id_prodi&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token\">&nbsp;&nbsp;Cancel&nbsp;&nbsp;</a>" ?>]
	  <input name="id_prodi" type="hidden" value="<? echo $id_prodi;?>"> <input name="id_kelas" type="hidden" value="<? echo $id_kelas;?>">      </td>
    </tr>	
  </table>
  <?
  }
