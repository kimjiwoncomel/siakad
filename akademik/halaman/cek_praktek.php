...
$nim=$_POST['nim'];
		...
		if($ada>=1)
	{
		...
		echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=home_admin.php?file=proses mahasiswa praktek&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi&id_kelas=$id_kelas&id_kurikulum=$id_kurikulum&th_akademik=$th_akademik&nim=$nim'></head><body><center><strong><font color='#FF0000'>Data Diproses...</font></strong></center></body></html>";
		exit;
	}
		...
		echo "<input name=\"Hapus\" type=\"submit\" id=\"hapus\" value=\"hapus\" />";
            ...
            <table width="100%" border="1" align="center" cellpadding="1" cellspacing="0">
              <tr>
				...
				<td width="56"><div align="center"><strong>Tanggal Mulai Praktek </strong></div></td>
                <td width="100"><div align="center"><strong>Tanggal Selesai Praktek </strong></div></td>
                <td width="74"><div align="center"><strong>Tempat Praktek </strong></div></td>
...
?>
              <tr>
               ...
               <td><div align="center"><? echo $data['nilai']; ?></div></td>
				...
				<td><div align="center"> <? echo "<a href=\"home_admin.php?file=proses mahasiswa praktek&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi&id_kelas=$id_kelas&id_kurikulum=$id_kurikulum&th_akademik=$th_akademik&nim=$data[nim]&id=$data[id]\">Edit</a></p>" ?></div></td>
				<? } ?>
			  </tr>
				
    </table>
<br>
<? echo "<p><a href=\"home_admin.php?file=cek mahasiswa praktek&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi&id_kelas=$id_kelas&id_kurikulum=$id_kurikulum&th_akademik=$th_akademik\">&nbsp;&nbsp;Kembali&nbsp;&nbsp;</a></p>" ?>