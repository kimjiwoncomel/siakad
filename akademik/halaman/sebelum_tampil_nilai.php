...
$cekquery= "SELECT *from krs_khs where id_prodi='$id_prodi' and  id_kelas='$id_kelas' and id_smt='$id_smt' and th_akademik='$th_akademik' group by id_mk order by id_smt asc";
...
while ($data = mysql_fetch_array($hacekquery)){
	...
	?>
                ...
                <tr onMouseOver=bgColor="#CCCCCC" onMouseOut=bgColor="#FFFFFF">                  
				  ...
				  <td class="kiribawahkanan" align="center"><? echo"<a href='home_admin.php?file=hasil input nilai khs&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi&id_smt=$id_smt&th_akademik=$th_akademik&id_kelas=$id_kelas&id_mk=$data[id_mk]'><strong><font color='#0000FF'> Edit / Input Nilai KHS / Upload Nilai KHS</font></strong></a>";?></td>    
    <? 
//	}
	}
	?>	 
