...
<tr><td align="left">
<? echo"<a href='home_admin.php?file=hasil cetak nilai uts&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi&id_smt=$id_smt&th_akademik=$th_akademik&id_kelas=$id_kelas'><strong><font color='#0000FF'>Kembali</font></strong></a>";?>
</td><td align="right">
<? echo"<a href='./halaman/cetak_uts.php?nim=$nim&semester=$semester&id_kelas=$id_kelas&id_kurikulum=$id_kurikulum&th_akademik=$th_akademik' target='_blank'><strong><font color='#0000FF'>Cetak Nilai UTS</font></strong></a>";?>
</td></tr>
</table>
...
$batas_smt=$data_smt2[no_urut];
	...
	$batas_smt2=max($batas_smt,$batas_smt,$batas_smt);
		...
		$ambil_krs_komulatif= "SELECT *from uts where id_mhs='$id_mhs' and th_akademik='$th_akademik' and id_smt='$id_smt'";
