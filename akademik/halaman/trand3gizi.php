...
<table width="100%" border="0" align="center" class="hurufarial">
  <tr>
    ...
    <td width="2%">&nbsp;</td>
 <td width="20%"><font size="-1">Program Studi : D-III Gizi<br>
    <em>Study ProgramDiploma III Nutrition </em></font></td>
...
?>
   ...
   <tr>
				  ...
				  <td class="kiribawahkanan" align="center">&nbsp;</td>   
   </tr> 
	<tr>
				  <td class="kiribawah" align="center"><font size="-1">&nbsp;</font></td>
  ...
  <tr>
    ...
    <td width="34%" align="center"><font size="-1">NIK : <? echo"$data_kajur2[nip]"; ?></font></td>
       ...
       <p align="center"><strong>Y U D I S I U M<br>
           <em>Proficiency</em></strong><br>
</p>
       <p>1. Judul Penulisan Karya Tulis ILmiah (KTI) :<br>
	   &nbsp;&nbsp;&nbsp;&nbsp;<em>Title of Scientific Paper  </em></p>
        <?
...
?>
  ...
  <tr>
      <td class="kotak"><div align="center"><? echo $ambil_judulnya[judul];?></div></td>
  </tr>
</table>
<?
	$jum_sks=$tot_sks+$tot_sks2+$tot_sks3+$tot_sks4+$tot_sks5+$tot_sks6;
...
while ($data_nilai = mysql_fetch_array($ambil_nilai)){
		if ($titik<=$data_nilai[bobot_max] and $titik>=$data_nilai[bobot_min]){
			$ind=$data_nilai[point];
		}
		}
		

		?>
<p>2. Predikat Keberhasilan Akhir Pendidikan  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? echo $ind;?><br>
&nbsp;&nbsp;&nbsp;<span class="style3">&nbsp;<span class="style4">Achivement Proficiency of Final Study Program &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? echo $luar;?></span></span></p>
  <table width="100%" border="0" class="garisbawah, hurufarial" align="center" cellpadding='1'>
