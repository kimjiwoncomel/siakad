  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="unnamed1">
                <tr bgcolor="#66FF00"> 
                  ...
                  <td class="kotak"><div align="center"><strong>Nama</strong></div></td>
				    <td class="kotak"><div align="center"><strong>Input Nilai Ujian </strong></div></td>
<?
...
$noUrut++;
	?>
                ...
                <tr onMouseOver=bgColor="#CCCCCC" onMouseOut=bgColor="#FFFFFF">                  
				  ...
				  <td class="kiribawahkanan" align="center"><? echo"<a href='home_admin.php?file=proses mahasiswa ujian&sinyal=$sinyal&identifikasi=$identifikasi&kategori=$kategori&token=$token&id_prodi=$id_prodi&id_kurikulum=$id_kurikulum&id_kelas=$id_kelas&th_akademik=$d[th_masuk]&id_smt=$id_smt&nim=$d[nim]'>proses</a>";?></td>
    <? 
	}
	?>	 
	</tr>
