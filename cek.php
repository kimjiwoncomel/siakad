...
$cekquery2= "select * from paswrd_khs where id_prodi='$id_prodi' and nim='$nim' and paswrd='$paswrd'";
...
if (mysql_num_rows($hacekquery2) == 1) 
	{
      ...
      $_SESSION['paswrd'] = $data2[paswrd];
	 $_SESSION['id_prodi'] = $data2[id_prodi]; 
 ...
 echo"<html><head><title></title><meta http-equiv='refresh'content='1;URL=akademik/homekhs.php'></head><body></body></html>";
 exit;
     }
}
